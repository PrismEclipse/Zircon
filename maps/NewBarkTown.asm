...
NewBarkTown_MapEvents:
	...
	warp_event 16, 11, ELMS_HOUSE, 1

	def_coord_events
	coord_event  7, 17, SCENE_NEWBARKTOWN_TEACHER_STOPS_YOU, NewBarkTown_TeacherStopsYouScene1
	coord_event  8, 17, SCENE_NEWBARKTOWN_TEACHER_STOPS_YOU, NewBarkTown_TeacherStopsYouScene2

	def_bg_events
	bg_event  8,  8, BGEVENT_READ, NewBarkTownSign
	bg_event 15,  8, BGEVENT_READ, NewBarkTownPlayersHouseSign
	bg_event  4, 12, BGEVENT_READ, NewBarkTownElmsLabSign
	bg_event  3,  3, BGEVENT_READ, NewBarkTownElmsHouseSign

	def_object_events
	object_event  2,  4, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
	object_event  8,  6, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
	object_event  0, 14, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownRivalScript, EVENT_RIVAL_NEW_BARK_TOWN
	object_event  9,  3, SPRITE_PACKAGE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownPackageScript, EVENT_NEW_BARK_TOWN_PACKAGE
