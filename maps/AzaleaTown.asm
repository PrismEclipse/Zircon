...
AzaleaTown_MapEvents:
	...
	warp_event 11, 11, CHARCOAL_KILN, 1
	warp_event 28,  5, AZALEA_MART, 2
	warp_event 20,  5, KURTS_HOUSE, 1
	warp_event 32, 11, AZALEA_GYM, 1
	warp_event 35,  3, SLOWPOKE_WELL_B1F, 1
	warp_event 17, 16, ILEX_FOREST_AZALEA_GATE, 3
	warp_event 39,  6, ILEX_FOREST_AZALEA_GATE, 4

	def_coord_events
	coord_event 27, 17, SCENE_AZALEATOWN_RIVAL_BATTLE, AzaleaTownRivalBattleScene1
	coord_event 28, 17, SCENE_AZALEATOWN_RIVAL_BATTLE, AzaleaTownRivalBattleScene2
	...
	bg_event 28, 11, BGEVENT_READ, AzaleaGymSign
	bg_event 32,  4, BGEVENT_READ, SlowpokeWellSign
	bg_event 23,  6, BGEVENT_READ, CharcoalKilnSign
	bg_event 16,  5, BGEVENT_READ, AzaleaTownPokecenterSign
	bg_event 30,  5, BGEVENT_READ, AzaleaTownMartSignScript
	bg_event 36,  7, BGEVENT_READ, AzaleaTownIlextForestSign
	bg_event 20, 13, BGEVENT_ITEM, AzaleaTownHiddenFullHeal
	bg_event 11,  6, BGEVENT_READ, AzaleaTownNoApricorn
	...
	object_event 23,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, AzaleaTownYoungsterScript, -1
	object_event 37, 13, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	...
	object_event 22, 13, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event 11,  6, SPRITE_APRICORN, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_WHITE, OBJECTTYPE_SCRIPT, 0, AzaleaTownApricornTree, EVENT_AZALEA_APRICORN
	...
	object_event  7,  4, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownRocket2Script, EVENT_SLOWPOKE_WELL_ROCKETS
