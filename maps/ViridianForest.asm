...
ViridianForest_MapEvents:
	...
	def_warp_events
	warp_event 33, 46, ROUTE_30, 2
	warp_event 33, 47, ROUTE_30, 3
	warp_event  4, 18, VIOLET_CITY, 1
	warp_event  4, 19, VIOLET_CITY, 2
	warp_event 21,  9, SOUL_HOUSE, 2
	def_coord_events

	def_bg_events
	bg_event 17, 22, BGEVENT_ITEM, ViridianForestHiddenMaxEther
	bg_event 13,  6, BGEVENT_ITEM, ViridianForestHiddenFullHeal
	bg_event  6, 38, BGEVENT_ITEM, ViridianForestHiddenFullRestore
	...
	object_event 32, 28, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, ViridianForestLeafStone, EVENT_VIRIDIAN_FOREST_LEAF_STONE
	...
	object_event 27, 13, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 1, TrainerBugCatcherEllis, -1
