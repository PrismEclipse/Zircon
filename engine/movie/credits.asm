...
Credits_LoadBorderGFX:
	...
	cp $ff
	jr z, .init
; SC: kurstraw has 8 frames instead of 4
	ld e, a
...
; SC: special case for kurstraw to slow down the anim
	dw CreditsKurstrawGFX
	dw CreditsKurstrawGFX     + 16 tiles
	dw CreditsKurstrawGFX     + 32 tiles
	dw CreditsKurstrawGFX     + 48 tiles
	dw CreditsKurstrawGFX     + 64 tiles
	dw CreditsKurstrawGFX     + 80 tiles
	dw CreditsKurstrawGFX     + 96 tiles
	dw CreditsKurstrawGFX     + 112 tiles
...
CreditsKurstrawGFX:     INCBIN "gfx/credits/magby.2bpp"
