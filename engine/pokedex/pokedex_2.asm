	...
	const DEXENTRY_AREA_SAFARI  ; 21
	const DEXENTRY_AREA_ROAMING ; 22 / 0x15
	const DEXENTRY_AREA_CASINO ; 23 / 0x16
	const DEXENTRY_AREA_NPCTRADES ; 24 / 0x17
	const DEXENTRY_AREA_EVENTWILDMONS ; 25 / 0x18
	const DEXENTRY_AREA_GIFTMONS ; 26 / 0x19
