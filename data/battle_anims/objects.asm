...
; BATTLE_ANIM_OBJ_WHIRLPOOL
	...
	; BATTLE_ANIM_OBJ_RADIAL_FLAME_SACRED_FIRE
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLE_ANIM_FRAMESET_FLAMETHROWER, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_FIRE
; BATTLE_ANIM_OBJ_ROCK_CLIMB
	battleanimobj RELATIVE_X | X_FLIP, $b2, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_ROCK_SMASH, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS	
