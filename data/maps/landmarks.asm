...
NewBarkTownName:     db "CHALECE<BSP>TOWN@"
CherrygroveCityName: db "TROVE<BSP>CITY@"
VioletCityName:      db "CHERIS CITY@"
AzaleaTownName:      db "MARKS TOWN@"
...
ViridianForestName:  db "VERDANT<BSP>FOREST@"
