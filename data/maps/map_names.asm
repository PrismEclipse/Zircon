...
Dungeons_Map_Names: ;newgroup DUNGEONS
	...
	dw Dungeons_Map_Name89 ; map_const SAFARI_ZONE_KANTO_ENTRANCE ; 89
	dw Dungeons_Map_Name90 ; map_const VICTORY_ROAD,                                10, 36 ; 90
	dw Dungeons_Map_Name91 ; map_const CLIFF_EDGE_GATE,                             10, 11 ; 91
	dw Dungeons_Map_Name92 ; map_const CLIFF_CAVE,                                   7, 20 ; 92
	dw Dungeons_Map_Name93 ; map_const CERULEAN_CAVE_1F,                            20, 14 ; 93
	dw Dungeons_Map_Name94 ; map_const CERULEAN_CAVE_2F,                            20, 14 ; 94
	dw Dungeons_Map_Name95 ; map_const CERULEAN_CAVE_B1F,                           20, 14 ; 95
...
Blackthorn_Map_Names: ;newgroup BLACKTHORN
	...
	dw Blackthorn_Map_Name2 ; map_const BLACKTHORN_DRAGON_SPEECH_HOUSE ;  2
	dw Blackthorn_Map_Name3 ; map_const BLACKTHORN_EMYS_HOUSE ;  3
	dw Blackthorn_Map_Name4 ; map_const BLACKTHORN_MART ;  4
	dw Blackthorn_Map_Name5 ; map_const BLACKTHORN_POKECENTER_1F ;  5
	dw Blackthorn_Map_Name6 ; map_const MOVE_DELETERS_HOUSE ;  6
	dw Blackthorn_Map_Name7 ; map_const ROUTE_45,                                    10, 45 ;  7
	dw Blackthorn_Map_Name8 ; map_const ROUTE_46,                                    10, 18 ;  8
	dw Blackthorn_Map_Name9 ; map_const BLACKTHORN_CITY,                             20, 18 ; 9
	assert_table_length NUM_BLACKTHORN_MAPS

Cinnabar_Map_Names: ;newgroup CINNABAR
	table_width 2, Cinnabar_Map_Names                                        ;  6
	dw Cinnabar_Map_Name1 ; map_const CINNABAR_POKECENTER_1F,                       5,  4 ;  1
	dw Cinnabar_Map_Name2 ; map_const ROUTE_19_FUCHSIA_GATE,                        5,  4 ;  2
	dw Cinnabar_Map_Name3 ; map_const SEAFOAM_GYM,                                 12, 11 ;  3
	dw Cinnabar_Map_Name4 ; map_const SEAFOAM_ISLANDS,                             12, 12 ;  4
	dw Cinnabar_Map_Name5 ; map_const SEAFOAM_ISLANDS_B1F,                         23, 13 ;  5
	dw Cinnabar_Map_Name6 ; map_const SEAFOAM_ISLANDS_B2F,                         20, 13 ;  6
	dw Cinnabar_Map_Name7 ; map_const SEAFOAM_ISLANDS_B3F,                         21, 13 ;  7
	dw Cinnabar_Map_Name8 ; map_const SEAFOAM_ISLANDS_B4F,                         21, 13 ;  8
	dw Cinnabar_Map_Name9 ; map_const ROUTE_19,                                    10, 27 ;  9
	dw Cinnabar_Map_Name10 ; map_const ROUTE_20,                                    48,  9 ; 10
	dw Cinnabar_Map_Name11 ; map_const ROUTE_21,                                    10, 43 ; 11
	dw Cinnabar_Map_Name12 ; map_const CINNABAR_ISLAND,                             12, 11 ; 12
	dw Cinnabar_Map_Name13 ; map_const POKEMON_MANSION_1F,                          15, 14 ; 13
	dw Cinnabar_Map_Name14 ; map_const POKEMON_MANSION_B1F,                         15, 14 ; 14
...
Cerulean_Map_Names: ;newgroup CERULEAN
	...
	dw Cerulean_Map_Name8 ; map_const POWER_PLANT,                                 10,  9 ; 8
	dw Cerulean_Map_Name9 ; map_const BILLS_HOUSE ; 9
	dw Cerulean_Map_Name10 ; map_const ROUTE_4,                                     20,  9 ; 10
	dw Cerulean_Map_Name11 ; map_const ROUTE_9,                                     30,  9 ; 11
	dw Cerulean_Map_Name12 ; map_const ROUTE_10_NORTH,                              10,  9 ; 12
	dw Cerulean_Map_Name13 ; map_const ROUTE_24,                                    10,  9 ; 13
	dw Cerulean_Map_Name14 ; map_const ROUTE_25,                                    30,  9 ; 14
	dw Cerulean_Map_Name15 ; map_const CERULEAN_CITY,                               20, 18 ; 15
...
Pewter_Map_Names: ;newgroup PEWTER
	...
	dw Pewter_Map_Name3 ; map_const PEWTER_NIDORAN_SPEECH_HOUSE,                  4,  4 ;  3
	dw Pewter_Map_Name4 ; map_const PEWTER_GYM,                                   5,  7 ;  4
	dw Pewter_Map_Name5 ; map_const PEWTER_MART,                                  6,  4 ;  5
	dw Pewter_Map_Name6 ; map_const PEWTER_POKECENTER_1F,                         5,  4 ;  6
	dw Pewter_Map_Name7 ; map_const PEWTER_SNOOZE_SPEECH_HOUSE,                   4,  4 ;  7
	dw Pewter_Map_Name8 ; map_const PEWTER_MUSEUM_1F,                            10,  4 ;  8
	dw Pewter_Map_Name9 ; map_const PEWTER_MUSEUM_2F,                             7,  4 ;  9
	dw Pewter_Map_Name10 ; map_const MOUNT_MOON_POKECENTER_1F,                     5,  4 ; 10
	dw Pewter_Map_Name11 ; map_const ROUTE_2_NORTH,                               12, 19 ; 11
...
Fast_Ship_Map_Names: ;newgroup FAST_SHIP
	...
	dw Fast_Ship_Map_Name11 ; map_const MOUNT_MOON_GIFT_SHOP,                         4,  4 ; 11
	dw Fast_Ship_Map_Name12 ; map_const TIN_TOWER_ROOF,                              10,  9 ; 12
	dw Fast_Ship_Map_Name13 ; map_const BURNED_TOWER_B1F,                            10,  9 ; 13
	dw Fast_Ship_Map_Name14 ; map_const BLACKTHORN_GYM_2F,                            5,  9 ; 14
...
Fuchsia_Map_Names: ;newgroup FUCHSIA
	...
	dw Fuchsia_Map_Name11 ; map_const SAFARI_ZONE_WARDENS_HOME ; 11
	dw Fuchsia_Map_Name12 ; map_const ROUTE_15_FUCHSIA_GATE ; 12
...
Lavender_Map_Names: ;newgroup LAVENDER
	...
	dw Lavender_Map_Name6 ; map_const MR_FUJIS_HOUSE ;  6
	dw Lavender_Map_Name7 ; map_const LAVENDER_SPEECH_HOUSE ;  7
	dw Lavender_Map_Name8 ; map_const LAVENDER_NAME_RATER ;  8
	dw Lavender_Map_Name9 ; map_const LAVENDER_MART ; 9
	dw Lavender_Map_Name10 ; map_const SOUL_HOUSE ; 10
	dw Lavender_Map_Name11 ; map_const LAV_RADIO_TOWER_1F,                          10,  4 ; 11
	dw Lavender_Map_Name12 ; map_const ROUTE_8_SAFFRON_GATE ; 12
	dw Lavender_Map_Name13 ; map_const ROUTE_12_SUPER_ROD_HOUSE ; 13
...
Celadon_Map_Names: ;newgroup CELADON
	...
	dw Celadon_Map_Name18 ; map_const CELADON_GAME_CORNER,                         10,  7 ; 18
	dw Celadon_Map_Name19 ; map_const CELADON_GAME_CORNER_PRIZE_ROOM ; 19
	dw Celadon_Map_Name20 ; map_const CELADON_GYM ; 20
	dw Celadon_Map_Name21 ; map_const CELADON_CAFE ; 21
	dw Celadon_Map_Name22 ; map_const ROUTE_16_FUCHSIA_SPEECH_HOUSE ; 22
	dw Celadon_Map_Name23 ; map_const ROUTE_16_GATE ; 23
	dw Celadon_Map_Name24 ; map_const ROUTE_7_SAFFRON_GATE ; 24
	dw Celadon_Map_Name25 ; map_const ROUTE_17_ROUTE_18_GATE ; 25
...
Viridian_Map_Names: ;newgroup VIRIDIAN ; 23
	...
	dw Viridian_Map_Name4 ; map_const VIRIDIAN_GYM,                                 5, 20 ;  4
	dw Viridian_Map_Name5 ; map_const VIRIDIAN_NICKNAME_SPEECH_HOUSE,               4,  4 ;  5
	dw Viridian_Map_Name6 ; map_const TRAINER_HOUSE_1F,                             5,  7 ;  6
	dw Viridian_Map_Name7 ; map_const TRAINER_HOUSE_B1F,                            5,  8 ;  7
	dw Viridian_Map_Name8 ; map_const VIRIDIAN_MART,                                6,  4 ;  8
	dw Viridian_Map_Name9 ; map_const VIRIDIAN_POKECENTER_1F,                       5,  4 ;  9
	dw Viridian_Map_Name10 ; map_const ROUTE_2_NUGGET_HOUSE,                         4,  4 ; 10
	dw Viridian_Map_Name11 ; map_const ROUTE_2_GATE,                                 5,  4 ; 11
	dw Viridian_Map_Name12 ; map_const VICTORY_ROAD_GATE,                           10,  9 ; 12
	dw Viridian_Map_Name13 ; map_const VIRIDIAN_FOREST,                             17, 28 ; 13
	dw Viridian_Map_Name14 ; map_const VIRIDIAN_FOREST_GATE_N,                       5,  4 ; 14
	dw Viridian_Map_Name15 ; map_const VIRIDIAN_FOREST_GATE_S,                       5,  4 ; 15
...
Saffron_Map_Names: ; 25
	...
	dw Saffron_Map_Name7 ; map_const MR_PSYCHICS_HOUSE ;  7
	dw Saffron_Map_Name8 ; map_const SAFFRON_MAGNET_TRAIN_STATION,                10,  9 ;  8
	dw Saffron_Map_Name9 ; map_const SILPH_CO_1F ; 9
	dw Saffron_Map_Name10 ; map_const COPYCATS_HOUSE_1F ; 10
	dw Saffron_Map_Name11 ; map_const COPYCATS_HOUSE_2F ; 11
	dw Saffron_Map_Name12 ; map_const ROUTE_5_UNDERGROUND_PATH_ENTRANCE ; 12
	dw Saffron_Map_Name13 ; map_const ROUTE_5_SAFFRON_GATE ; 13
	dw Saffron_Map_Name14 ; map_const ROUTE_5_CLEANSE_TAG_HOUSE ; 14
...
SafariZoneGate_Map_Names:
	table_width 2, SafariZoneGate_Map_Names
	dw SafariZoneGate_MapName1 ; map_const ROUTE_47,                                    39, 19 ;  1
	dw SafariZoneGate_MapName2 ; map_const ROUTE_48,                                    18, 10 ;  2
	dw SafariZoneGate_MapName3 ; map_const SAFARI_ZONE_ENTRANCE,                         5,  5 ;  3
	dw SafariZoneGate_MapName4 ; map_const SAFARI_ZONE_GATE,                            12, 10 ;  4
	dw SafariZoneGate_MapName5 ; map_const SAFARI_ZONE_GATE_POKECENTER_1F,               5,  4 ;  5
	dw SafariZoneGate_MapName6 ; map_const SAFARI_ZONE_AREA_1,                          20, 16 ;  6
	dw SafariZoneGate_MapName7 ; map_const SAFARI_ZONE_AREA_2,                          22, 19 ;  7
	dw SafariZoneGate_MapName8 ; map_const SAFARI_ZONE_AREA_4,                          20, 24 ;  8
	dw SafariZoneGate_MapName9 ; map_const SAFARI_REST_HOUSE_AREA_1,                     4,  4 ;  9
	dw SafariZoneGate_MapName10 ; map_const SAFARI_REST_HOUSE_AREA_2,                     4,  4 ; 10
	dw SafariZoneGate_MapName11 ; map_const SAFARI_REST_HOUSE_AREA_3,                     4,  4 ; 11
	dw SafariZoneGate_MapName12 ; map_const SAFARI_REST_HOUSE_AREA_4,                     4,  4 ; 12
	assert_table_length NUM_SAFARI_ZONE_GATE_MAPS

SafariZone_Map_Names:
		table_width 2, SafariZone_Map_Names
	dw SafariZone_MapName1 ; map_const SAFARI_ZONE_AREA_3,                          21, 17 ;  1
	dw SafariZone_MapName2 ; map_const SILVER_CAVE_LOWER_MOUNTAINSIDE,              15, 20 ;  2
	dw SafariZone_MapName3 ; map_const SILVER_CAVE_UPPER_MOUNTAINSIDE,              17, 18 ;  3
	dw SafariZone_MapName4 ; map_const MOUNT_MOON_B1F,                              14, 13 ;  4
	dw SafariZone_MapName5 ; map_const MOUNT_MOON_B2F,                              14, 12 ;  5
	dw SafariZone_MapName6 ; map_const SAFARI_ZONE_KANTO_AREA_1,                    15, 15 ;  6
	dw SafariZone_MapName7 ; map_const SAFARI_ZONE_KANTO_AREA_2,                    15, 13 ;  7
	dw SafariZone_MapName8 ; map_const SAFARI_ZONE_KANTO_AREA_3,                    20, 18 ;  8
	dw SafariZone_MapName9 ; map_const SAFARI_ZONE_KANTO_AREA_4,                    15, 13 ;  9
	dw SafariZone_MapName10 ; map_const SAFARI_KANTO_REST_HOUSE_AREA_1,               4,  4 ; 10
	dw SafariZone_MapName11 ; map_const SAFARI_KANTO_REST_HOUSE_AREA_2,               4,  4 ; 12
	dw SafariZone_MapName12 ; map_const SAFARI_KANTO_REST_HOUSE_AREA_3,               4,  4 ; 13
	dw SafariZone_MapName13 ; map_const SAFARI_KANTO_REST_HOUSE_AREA_4,               4,  4 ; 14
	dw SafariZone_MapName14 ; map_const SAFARI_KANTO_SECRET_HOUSE,                    4,  4 ; 15
...
Dungeons_Map_Name88: ; map_const ROCK_TUNNEL_B1F,; 88
	db "ROCK TUNNEL B1F@"
Dungeons_Map_Name89: ; map_const SAFARI_ZONE_BETA,; 89
	db "SAFARI GATE@"
Dungeons_Map_Name90: ; map_const VICTORY_ROAD,;  90
	db "VICTORY ROAD@"
Dungeons_Map_Name91: ; map_const VICTORY_ROAD,;  91
	db "CLIFF GATE@"
Dungeons_Map_Name92: ; map_const VICTORY_ROAD,;  92
	db "CLIFF CAVE@"	
Dungeons_Map_Name93: ; map_const VICTORY_ROAD,;  93
	db "CERULEAN CAVE 1F@"
Dungeons_Map_Name94: ; map_const VICTORY_ROAD,;  94
	db "CERULEAN CAVE 2F@"
Dungeons_Map_Name95: ; map_const VICTORY_ROAD,;  93
...
Blackthorn_Map_Name1: ; map_const BLACKTHORN_GYM_1F ;  1
	db "BLACKTHORN GYM@"
Blackthorn_Map_Name2: ; map_const BLACKTHORN_DRAGON_SPEECH_HOUSE ;  2
	db "DRAGON HOUSE@"
Blackthorn_Map_Name3: ; map_const BLACKTHORN_EMYS_HOUSE ;  3
	db "EMY'S HOUSE@"
Blackthorn_Map_Name4: ; map_const BLACKTHORN_MART ;  4
	db "BLACKTHORN <POKE>MART@"
Blackthorn_Map_Name5: ; map_const BLACKTHORN_POKECENTER_1F ;  5
	db "BLACKTH. <PKMN> CENTER@"
Blackthorn_Map_Name6: ; map_const MOVE_DELETERS_HOUSE ;  6
	db "MOVE DELETER@"
...
Cinnabar_Map_Name2: ; map_const ROUTE_19_FUCHSIA_GATE ;  2
	db "ROUTE 19 GATE@"
Cinnabar_Map_Name3: ; map_const SEAFOAM_GYM ;  3
	db "SEAFOAM GYM@"
Cinnabar_Map_Name4: ; map_const SEAFOAM_ISLANDS ;  3
	db "SEAFOAM ISLANDS@"	
Cinnabar_Map_Name5: ; map_const SEAFOAM_ISLANDS ;  3
	db "SEAFOAM ISLANDS B1F@"	
Cinnabar_Map_Name6: ; map_const SEAFOAM_ISLANDS ;  3
	db "SEAFOAM ISLANDS B2F@"
Cinnabar_Map_Name7: ; map_const SEAFOAM_ISLANDS ;  3
	db "SEAFOAM ISLANDS B3F@"
Cinnabar_Map_Name8: ; map_const SEAFOAM_ISLANDS ;  3
	db "SEAFOAM ISLANDS B4F@"	
Cinnabar_Map_Name9: ; map_const ROUTE_19, ;  5
	db "ROUTE 19@"
Cinnabar_Map_Name10: ; map_const ROUTE_20,;  6
	db "ROUTE 20@"
Cinnabar_Map_Name11: ; map_const ROUTE_21,;  7
	db "ROUTE 21@"
Cinnabar_Map_Name12: ; map_const CINNABAR_ISLAND,;  7
	db "CINNABAR ISLAND@"
Cinnabar_Map_Name13: ; map_const CINNABAR_ISLAND,;  7
	db "POKEMON MANSION 1F@"
Cinnabar_Map_Name14: ; map_const CINNABAR_ISLAND,;  7
	db "POKEMON MANSION B1F@"	
...
Cerulean_Map_Name5: ; map_const CERULEAN_GYM ;  6
	db "CERULEAN GYM@"
Cerulean_Map_Name6: ; map_const CERULEAN_MART ;  7
	db "CERULEAN #MART@"
Cerulean_Map_Name7: ; map_const ROUTE_10_POKECENTER_1F ;  8
	db "ROUTE 10 <PKMN> CENTER@"
Cerulean_Map_Name8: ; map_const POWER_PLANT,; 10
	db "POWER PLANT@"
Cerulean_Map_Name9: ; map_const BILLS_HOUSE ; 11
	db "BILL'S HOUSE@"
Cerulean_Map_Name10: ; map_const ROUTE_4,; 12
	db "ROUTE 4@"
Cerulean_Map_Name11: ; map_const ROUTE_9,; 13
	db "ROUTE 9@"
Cerulean_Map_Name12: ; map_const ROUTE_10_NORTH,; 14
	db "ROUTE 10, NORTH@"
Cerulean_Map_Name13: ; map_const ROUTE_24,; 15
	db "ROUTE 24@"
Cerulean_Map_Name14: ; map_const ROUTE_25,; 16
	db "ROUTE 25@"
Cerulean_Map_Name15: ; map_const CERULEAN_CITY,;  8
	db "CERULEAN CITY@"
...
Pewter_Map_Name7: ; map_const PEWTER_SNOOZE_SPEECH_HOUSE ;  8
	db "PEWTER HOUSE 2@"                                          ; 15
Pewter_Map_Name8: ; map_const PEWTER_SNOOZE_SPEECH_HOUSE ;  8
	db "PEWTER MUSEUM 1F@"                                          ; 15
Pewter_Map_Name9: ; map_const PEWTER_SNOOZE_SPEECH_HOUSE ;  8
	db "PEWTER MUSEUM 2F@"                                          ; 15
Pewter_Map_Name10: ; map_const PEWTER_SNOOZE_SPEECH_HOUSE ;  8
	db "MOUNT MOON <PKMN> CENTER@"                                          ; 15
Pewter_Map_Name11: ; map_const PEWTER_SNOOZE_SPEECH_HOUSE ;  8
	db "ROUTE 2 NORTH@"                                          ; 15
...
Fast_Ship_Map_Name12: ; map_const TIN_TOWER_ROOF, 12
	db "TIN TOWER ROOF@"      
Fast_Ship_Map_Name13: ; map_const TIN_TOWER_ROOF, 12
	db "BURNED TOWER B1F@"      	; 16
Fast_Ship_Map_Name14: ; map_const TIN_TOWER_ROOF, 12
...
Fuchsia_Map_Name11: ; map_const SAFARI_ZONE_WARDENS_HOME ; 12
	db "WARDEN'S HOUSE@"
Fuchsia_Map_Name12: ; map_const ROUTE_15_FUCHSIA_GATE ; 13
	db "FUCHSIA GATE@"
...
Lavender_Map_Name6: ; map_const MR_FUJIS_HOUSE ;  7
	db "MR. FUJI'S HOUSE@"
Lavender_Map_Name7: ; map_const LAVENDER_SPEECH_HOUSE ;  8
	db "LAVENDER HOUSE 1@"
Lavender_Map_Name8: ; map_const LAVENDER_NAME_RATER ;  9
	db "KANTO NAME RATER@"
Lavender_Map_Name9: ; map_const LAVENDER_MART ; 10
	db "LAVENDER #MART@"
Lavender_Map_Name10: ; map_const SOUL_HOUSE ; 11
	db "SOUL HOUSE@"
Lavender_Map_Name11: ; map_const LAV_RADIO_TOWER_1F,; 12
	db "KANTO RADIO TOWER@"
Lavender_Map_Name12: ; map_const ROUTE_8_SAFFRON_GATE ; 13
	db "ROUTE 8 GATE@"
Lavender_Map_Name13: ; map_const ROUTE_12_SUPER_ROD_HOUSE ; 14
...
Celadon_Map_Name18: ; map_const CELADON_GAME_CORNER, 19
	db "CELADON GAMECORNER@"
Celadon_Map_Name19: ; map_const CELADON_GAME_CORNER_PRIZE_ROOM ; 20
	db "CELADON PRIZE ROOM@"
Celadon_Map_Name20: ; map_const CELADON_GYM ; 21
	db "CELADON GYM@"
Celadon_Map_Name21: ; map_const CELADON_CAFE ; 22
	db "CELADON CAFE@"
Celadon_Map_Name22: ; map_const ROUTE_16_FUCHSIA_SPEECH_HOUSE ; 23
	db "ROUTE 16 HOUSE@"
Celadon_Map_Name23: ; map_const ROUTE_16_GATE ; 24
	db "ROUTE 16 GATE@"
Celadon_Map_Name24: ; map_const ROUTE_7_SAFFRON_GATE ; 25
	db "ROUTE 7 GATE@"
Celadon_Map_Name25: ; map_const ROUTE_17_ROUTE_18_GATE ; 26 
...
Viridian_Map_Name10: ; map_const ROUTE_2_NUGGET_HOUSE ; 11
	db "RT. 2 NUGGET HOUSE@"
Viridian_Map_Name11: ; map_const ROUTE_2_GATE ; 12
	db "ROUTE 2 GATE@"
Viridian_Map_Name12: ; map_const VICTORY_ROAD_GATE, 13
	db "VICTORY ROAD GATE@"
Viridian_Map_Name13: ; map_const VICTORY_ROAD_GATE, 13
	db "VIRIDIAN FOREST@"
Viridian_Map_Name14: ; map_const VICTORY_ROAD_GATE, 13
	db "VIRIDIAN FOREST GATE N@"
Viridian_Map_Name15: ; map_const VICTORY_ROAD_GATE, 13
...
Saffron_Map_Name7: ; map_const MR_PSYCHICS_HOUSE ;  8
	db "MR.PSYCHIC'S HOUSE@"
Saffron_Map_Name8: ; map_const SAFFRON_MAGNET_TRAIN_STATION,;  9
	db "SAFFRON STATION@"
Saffron_Map_Name9: ; map_const SILPH_CO_1F ; 10
	db "SILPH CO.@"
Saffron_Map_Name10: ; map_const COPYCATS_HOUSE_1F ; 11
	db "COPYCAT HOUSE 1F@"
Saffron_Map_Name11: ; map_const COPYCATS_HOUSE_2F ; 12
	db "COPYCAT HOUSE 2F@"
Saffron_Map_Name12: ; map_const ROUTE_5_UNDERGROUND_PATH_ENTRANCE ; 13
	db "ROUTE 5 UNDERGRND@"
Saffron_Map_Name13: ; map_const ROUTE_5_SAFFRON_GATE ; 14
	db "ROUTE 5 GATE@"
Saffron_Map_Name14: ; map_const ROUTE_5_CLEANSE_TAG_HOUSE ; 15
	db "ROUTE 5 HOUSE@"
...
SafariZoneGate_MapName1: ; map_const ROUTE_30         ;  1
	db "ROUTE 47@"
SafariZoneGate_MapName2: ; map_const ROUTE_31         ;  2
	db "ROUTE 48@"
SafariZoneGate_MapName3: ; map_const CHERRYGROVE_CITY ;  3
	db "SAFARI ZONE ENTRANCE@"
SafariZoneGate_MapName4: ; map_const CHERRYGROVE_MART ;  4
	db "SAFARI ZONE GATE@"
SafariZoneGate_MapName5: ; map_const CHERRYGROVE_POKECENTER_1F ;  5
	db "SAFARI <PKMN> CENTER@"
SafariZoneGate_MapName6: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE AREA 1@"
SafariZoneGate_MapName7: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE AREA 2@"
SafariZoneGate_MapName8: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE AREA 4@"
SafariZoneGate_MapName9: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE REST HOUSE 1@"
SafariZoneGate_MapName10: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE REST HOUSE 2@"
SafariZoneGate_MapName11: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE REST HOUSE 3@"
SafariZoneGate_MapName12: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "SAFARI ZONE REST HOUSE 4@"
	
SafariZone_MapName1: ; map_const ROUTE_30         ;  1
	db "SFARI ZONE AREA 3@"
SafariZone_MapName2: ; map_const ROUTE_31         ;  2
	db "SILVER CAVE MOUNTAINSIDE@"
SafariZone_MapName3: ; map_const CHERRYGROVE_CITY ;  3
	db "SILVER CAVE MOUNTAINSIDE 2@"
SafariZone_MapName4: ; map_const CHERRYGROVE_MART ;  4
	db "MT MOON B1F@"
SafariZone_MapName5: ; map_const CHERRYGROVE_POKECENTER_1F ;  5
	db "MT MOON B2F@"
SafariZone_MapName6: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE 1@"
SafariZone_MapName7: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE 2@"
SafariZone_MapName8: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE 3@"
SafariZone_MapName9: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE 4@"
SafariZone_MapName10: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE HOUSE 1@"
SafariZone_MapName11: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE HOUSE 2@"
SafariZone_MapName12: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE HOUSE 3@"
SafariZone_MapName13: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE HOUSE 4@"	
SafariZone_MapName14: ; map_const CHERRYGROVE_GYM_SPEECH_HOUSE ;  6
	db "KANTO SAFARI ZONE SECRET HOUSE@"		
