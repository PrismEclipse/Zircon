...
ENDM
	...
	connection north, Route29, ROUTE_29, 10
	connection south, Route19, ROUTE_19, 6
	connection west, Route30, ROUTE_30, -18

	map_attributes VioletCity, VIOLET_CITY, $05, WEST
	connection west, Route32, ROUTE_32, -1
	...
	connection east, CherrygroveCity, CHERRYGROVE_CITY, 18
	
	map_attributes Route32, ROUTE_32, $05, EAST
	...
	map_attributes Route20, ROUTE_20, $43, WEST
	connection west, CinnabarIsland, CINNABAR_ISLAND, -2

	map_attributes Route19, ROUTE_19, $35, NORTH
	connection north, CherrygroveCity, CHERRYGROVE_CITY, -6
	...
	map_attributes Route31, ROUTE_31, $fd, 0
	map_attributes Route36, ROUTE_36, $fd, 0
