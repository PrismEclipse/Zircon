...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move BIDE,         EFFECT_NORMAL_HIT,          1, NORMAL,       100, 10,   0
	...
	move FURY_CUTTER,  EFFECT_NORMAL_HIT,        20, BUG,           95, 20,   0 ; OLD POWER: 10
	...
	move ROCK_CLIMB,   EFFECT_CONFUSE_HIT,        130, NORMAL, 85, 25,  40
